                      ...
                      <div className="flex items-center space-x-2 border rounded-md p-3 border-sky-200 dark:border-sky-800">
                        ...
                        <Select value={fromLocation} onValueChange={setFromLocation} required>
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="San Francisco (SFO)">San Francisco (SFO)</SelectItem>
                            <SelectItem value="Dallas (DFW)">Dallas (DFW)</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                      <div className="flex items-center space-x-2 border rounded-md p-3 border-sky-200 dark:border-sky-800">
                        ...
                        <Select value={toLocation} onValueChange={setToLocation} required>
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="Rome (FCO)">Rome (FCO)</SelectItem>
                            <SelectItem value="Tokyo (HND)">Tokyo (HND)</SelectItem>
