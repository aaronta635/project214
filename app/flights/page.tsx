  ...
  useEffect(() => {
    ...
    const generateFlights = () => {
      ...
      const calculateFlightDetails = (from: string, to: string, departureTime: string) => {
        ...
        if ((from.includes("JFK") && to.includes("LAX")) || (from.includes("LAX") && to.includes("JFK"))) {
          durationHours = 6
        } else if (
          (from.includes("JFK") ||
            from.includes("LAX") ||
            ...
            from.includes("SFO") ||
            from.includes("DFW")) &&
          (to.includes("LHR") || to.includes("CDG") || to.includes("FCO"))
        ) {
          durationHours = 8 // US to Europe
        } else if (
          (from.includes("JFK") ||
            from.includes("LAX") ||
            from.includes("ORD") ||
            ...
            from.includes("SFO") ||
            from.includes("DFW")) &&
          (to.includes("HND") || to.includes("SIN"))
        ) {
          durationHours = 14 // US to Asia
        } else if (
          (from.includes("JFK") ||
            from.includes("LAX") ||
            from.includes("ORD") ||
          ...
          durationHours = 12 // US to Middle East
        } else {
          durationHours = 4 // Default for shorter flights
        }
      ...
      const calculatePrice = (from: string, to: string, departureTime: string) => {
        ...
        if ((from.includes("JFK") && to.includes("LAX")) || (from.includes("LAX") && to.includes("JFK"))) {
          ...
          basePrice = 1000 // US to Middle East
        } else {
          basePrice = 200 // Default for shorter flights
        }
