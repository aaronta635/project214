  ...
  const [meals, setMeals] = useState([
    {
      id: "pad-thai",
      name: "Pad Thai",
      description: "Traditional Thai stir-fried rice noodles with shrimp, tofu, and peanuts.",
      price: 18.99,
      selected: true,
      image: "/placeholder.svg?height=160&width=320&text=Pad+Thai",
    },
    {
      id: "sushi-bento",
      name: "Sushi Bento Box",
      description: "Fresh sushi selection with miso soup and edamame.",
      price: 22.99,
      selected: false,
      image: "/placeholder.svg?height=160&width=320&text=Sushi+Bento",
    },
    {
      id: "korean-bibimbap",
      ...
      price: 19.99,
      selected: false,
      image: "/placeholder.svg?height=160&width=320&text=Korean+Bibimbap",
    },
    {
      id: "laksa",
      ...
      price: 17.99,
      selected: false,
      image: "/placeholder.svg?height=160&width=320&text=Singapore+Laksa",
    },
  ])
